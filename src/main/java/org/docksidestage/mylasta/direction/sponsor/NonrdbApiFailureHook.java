 ...
 * @author jflute
 */
public class NonrdbApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    public static class UnifiedFailureResult {
        ...
        public final String notice = "[Attension] tentative JSON so you should change it: " + NonrdbApiFailureHook.class;
        @Required
