 ...
 * @author jflute
 */
public class NonrdbTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final NonrdbConfig config;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public NonrdbTimeResourceProvider(NonrdbConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return NonrdbUserTimeZoneProcessProvider.centralTimeZone;
    }
