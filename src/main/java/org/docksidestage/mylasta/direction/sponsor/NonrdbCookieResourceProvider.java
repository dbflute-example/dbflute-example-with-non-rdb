 ...
 * @author jflute
 */
public class NonrdbCookieResourceProvider implements CookieResourceProvider {

    protected final NonrdbConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public NonrdbCookieResourceProvider(NonrdbConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
