 ...
 * @author FreeGen
 */
public interface NonrdbHtmlPath {

    /** The path of the HTML: /error/show_errors.html */
    HtmlNext path_Error_ShowErrorsHtml = new HtmlNext("/error/show_errors.html");

    /** The path of the HTML: /es/product/es_product_add.jsp */
    HtmlNext path_EsProduct_EsProductAddJsp = new HtmlNext("/es/product/es_product_add.jsp");

    /** The path of the HTML: /es/product/es_product_detail.jsp */
    HtmlNext path_EsProduct_EsProductDetailJsp = new HtmlNext("/es/product/es_product_detail.jsp");

    /** The path of the HTML: /es/product/es_product_list.jsp */
    HtmlNext path_EsProduct_EsProductListJsp = new HtmlNext("/es/product/es_product_list.jsp");
