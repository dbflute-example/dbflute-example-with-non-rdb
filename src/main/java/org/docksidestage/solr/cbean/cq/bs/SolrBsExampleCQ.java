 ...
 */
package org.docksidestage.solr.cbean.cq.bs;
...
/**
 * Base Query class of Solr schema "Example."
 * @author FreeGen
 */
public class SolrBsExampleCQ extends AbstractSolrQueryBean {
    ...
    public void addOrderBy_LatestPurchaseDate_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.LatestPurchaseDate.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_LatestPurchaseDate_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.LatestPurchaseDate.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_ProductCategory_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductCategory.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_ProductCategory_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductCategory.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_ProductCategoryCode_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductCategoryCode.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_ProductCategoryCode_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductCategoryCode.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_ProductHandleCode_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductHandleCode.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_ProductHandleCode_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductHandleCode.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_ProductName_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductName.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_ProductName_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductName.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_ProductStatus_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductStatus.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_ProductStatus_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductStatus.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_ProductStatusCode_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductStatusCode.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_ProductStatusCode_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.ProductStatusCode.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_RegisterDatetime_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.RegisterDatetime.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_RegisterDatetime_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.RegisterDatetime.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_RegisterUser_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.RegisterUser.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_UpdateDatetime_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.UpdateDatetime.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_UpdateDatetime_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.UpdateDatetime.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
    ...
    public void addOrderBy_UpdateUser_Desc() {
        SortClause clause = new SortClause(SolrExampleDbm.UpdateUser.fieldName(), ORDER.desc);
        solrSortClauseList.add(clause);
    }

    public void addOrderBy_UpdateUser_Asc() {
        SortClause clause = new SortClause(SolrExampleDbm.UpdateUser.fieldName(), ORDER.asc);
        solrSortClauseList.add(clause);
    }
   ...
   /**
     ...
     */
    public void orScopeQuery(SolrQBCall<SolrExampleCQ> orQueryLambda) {
   ...
   /**
     ...
     */
    public void orScopeQueryAndPart(SolrQBCall<SolrExampleCQ> orQueryAndPartLambda) {
        SolrExampleCQ queryBean = new SolrExampleCQ();
