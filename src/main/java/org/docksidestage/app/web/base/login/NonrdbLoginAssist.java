 ...
 * @author jflute
 */
public class NonrdbLoginAssist extends TypicalLoginAssist<Integer, NonrdbUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected NonrdbUserBean createUserBean(Member userEntity) {
        return new NonrdbUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeNonrdbKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, NonrdbUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<NonrdbUserBean> getUserBeanType() {
        return NonrdbUserBean.class;
    }
