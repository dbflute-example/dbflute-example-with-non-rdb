 ...
 * @author jflute
 */
public abstract class NonrdbBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<NonrdbMessages>, NonrdbHtmlPath {
    ...
    @Override
    public ActionValidator<NonrdbMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public NonrdbMessages createMessages() { // application may call
        return new NonrdbMessages(); // overriding to change return type to concrete-class
    }
